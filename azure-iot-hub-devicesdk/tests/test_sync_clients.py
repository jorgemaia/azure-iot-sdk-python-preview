...
class ClientSharedTests(object):
    ...
    def test_instantiation_sets_on_method_request_recieved_handler_in_transport(self, client):
...
class TestModuleClient(ClientSharedTests):
    ...
    def test_instantiation_sets_on_input_message_recieved_handler_in_transport(self, client):
...
class TestDeviceClient(ClientSharedTests):
    ...
    def test_instantiation_sets_on_c2d_message_recieved_handler_in_transport(self, client):
